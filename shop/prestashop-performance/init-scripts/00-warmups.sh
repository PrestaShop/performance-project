#!/bin/bash
	...
	echo ""
        ...
        sleep 5 && echo "Warming up FO cache...\n" && curl -I -H"Host: $PS_DOMAIN" --retry 5 http://localhost/index.php? && echo "FO cache warming done\n" &
        ...
        sleep 6 && echo "Warming up BO cache...\n" && curl -I -H"Host: $PS_DOMAIN" --retry 5 http://localhost/${PS_FOLDER_ADMIN}/index.php?controller=AdminLogin && echo "BO cache warming done\n" &
