...
object FrontOfficeCartSimulation {
  ...
  val buy = scenario("Cart")
    ...
    .pause("${pauseAfterEachStep}")
    .exec(http("FrontOfficeCart " + "order #2  type address and get token")
